...
python3 plots.py -f results/brokers-broker-linear/brokers-broker-linear.csv -g brokers-broker-linear -t 'increasing brokers - 5 pubs - 5 subs - broker dissemination - linear topology'
python3 plots.py -f results/brokers-broker-tree/brokers-broker-tree.csv -g brokers-broker-tree -t 'increasing brokers - 5 pubs - 5 subs - broker dissemination - tree topology' -u .001
