...
#sudo mn -c
#sudo python3 topoLinear.py -d broker -p 6 -s 6 -r 1 -t 200
#sudo mn -c
#sudo python3 topoLinear.py -d broker -p 8 -s 8 -r 1 -t 200 -k 12
#sudo mn -c
sudo python3 topoLinear.py -d broker -p 10 -s 10 -r 1 -t 200 -n 3 -k 15
#sudo mn -c
