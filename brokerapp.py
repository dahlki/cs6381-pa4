...
def parseCmdLineArgs():
    ...
    parser.add_argument("-r", "--replica", type=int, choices=[1, 2, 3], default=1, help="number of backup replicas for load balancing")
...
async def main():
    ...
    broker = config.get_broker(args.replica)
    registry = Registry("broker", ip, args.port, args.disseminate, broker, args.registryIP, args.replica)
    registry.register()
